...
// Using PNG mockups with transparent backgrounds for proper color overlay
export const MOCKUP_PRODUCTS: MockupProduct[] = [
  ...
  },
  {
    ...
    views: [
      { id: 'front', name: 'Front', angle: 'front', mockupUrl: '/mockups/basketball_hoodie_mockup.png', maskUrl: '/mockups/basketball_hoodie_mask.svg', shadowUrl: '' },
      { id: 'back', name: 'Back', angle: 'back', mockupUrl: '/mockups/basketball_hoodie_back_mockup.png', maskUrl: '/mockups/basketball_hoodie_back_mask.svg', shadowUrl: '' },
    ],
