...
async function main() {
  ...
  // Create the default business first (required for all products)
  const business = await prisma.business.upsert({
    ...
    create: {
      ...
      slug: 'basketball-factory',
      description: 'Premium basketball apparel and gear for Rise as One AAU Club and The Basketball Factory. Performance-driven designs for champions.',
      email: 'gear@basketballfactory.com',
      phone: '(973) 555-0123',
      ...
      zipCode: '07871',
      country: 'US',
      website: 'https://basketballfactory.com',
      primaryColor: '#FF6B00',
